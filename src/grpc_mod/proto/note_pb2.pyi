...
class Note(_message.Message):
    __slots__ = ("id", "title", "content", "updated_at", "author_id", "permissions", "directory_ids", "tag_ids", "user_id", "attachment_ids")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
...
class PostNoteRequest(_message.Message):
    __slots__ = ("title", "content", "author_id", "user_id")
    TITLE_FIELD_NUMBER: _ClassVar[int]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    AUTHOR_ID_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    author_id: str
    user_id: str
    def __init__(self, title: _Optional[str] = ..., content: _Optional[str] = ..., author_id: _Optional[str] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class Directory(_message.Message):
    __slots__ = ("id", "slug", "display_name", "description", "image_url", "parent_dir_ids", "relationships", "child_dir_ids", "child_note_ids")
    ID_FIELD_NUMBER: _ClassVar[int]
    SLUG_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
...
class GetDirectoryRequest(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., user_id: _Optional[str] = ..., include_parents: bool = ..., include_child_dirs: bool = ..., include_child_notes: bool = ...) -> None: ...

class GetDirectoriesRequest(_message.Message):
    __slots__ = ("user_id", "parent_id", "limit", "offset", "include_parents", "include_child_dirs", "include_child_notes")
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    include_child_dirs: bool
    include_child_notes: bool
    def __init__(self, user_id: _Optional[str] = ..., parent_id: _Optional[str] = ..., limit: _Optional[int] = ..., offset: _Optional[int] = ..., include_parents: bool = ..., include_child_dirs: bool = ..., include_child_notes: bool = ...) -> None: ...
...
class NoteVersionSummary(_message.Message):
    ...
    is_snapshot: bool
    snapshot_id: str
    def __init__(self, version_id: _Optional[str] = ..., note_id: _Optional[str] = ..., version_index: _Optional[int] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., author_id: _Optional[str] = ..., is_snapshot: bool = ..., snapshot_id: _Optional[str] = ...) -> None: ...
