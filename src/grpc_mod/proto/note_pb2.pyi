...
class _PermissionObjectTypeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_PermissionObjectType.ValueType], _builtins.type):
    ...
    PERMISSION_OBJECT_TYPE_ROLE: _PermissionObjectType.ValueType  # 5
...
PERMISSION_OBJECT_TYPE_ROLE: PermissionObjectType.ValueType  # 5
...
class Note(_message.Message):
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["updated_at", b"updated_at"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["attachment_ids", b"attachment_ids", "author_id", b"author_id", "content", b"content", "directory_ids", b"directory_ids", "id", b"id", "permissions", b"permissions", "shelf_ids", b"shelf_ids", "tag_ids", b"tag_ids", "title", b"title", "updated_at", b"updated_at", "user_id", b"user_id"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...
...
class PostNoteRequest(_message.Message):
    ...
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["_content", b"_content", "author_id", b"author_id", "content", b"content", "directory_ids", b"directory_ids", "shelf_id", b"shelf_id", "title", b"title", "user_id", b"user_id"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
