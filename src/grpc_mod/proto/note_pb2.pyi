...
class PermissionObjectType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PERMISSION_OBJECT_TYPE_ROLE: _ClassVar[PermissionObjectType]
...
PERMISSION_OBJECT_TYPE_ROLE: PermissionObjectType
...
class NotesReply(_message.Message):
    __slots__ = ("notes", "directories", "tags")
    NOTES_FIELD_NUMBER: _ClassVar[int]
    DIRECTORIES_FIELD_NUMBER: _ClassVar[int]
    TAGS_FIELD_NUMBER: _ClassVar[int]
    notes: _containers.RepeatedCompositeFieldContainer[MinimalNote]
    directories: _containers.RepeatedCompositeFieldContainer[MinimalDirectory]
    tags: _containers.RepeatedCompositeFieldContainer[MinimalTag]
    def __init__(self, notes: _Optional[_Iterable[_Union[MinimalNote, _Mapping]]] = ..., directories: _Optional[_Iterable[_Union[MinimalDirectory, _Mapping]]] = ..., tags: _Optional[_Iterable[_Union[MinimalTag, _Mapping]]] = ...) -> None: ...

class MinimalNote(_message.Message):
    __slots__ = ("id", "title", "author_id", "updated_at", "stripped_content", "permissions", "directory_ids", "tag_ids")
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., author_id: _Optional[str] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., stripped_content: _Optional[str] = ..., permissions: _Optional[_Iterable[_Union[PermissionRelationship, _Mapping]]] = ..., directory_ids: _Optional[_Iterable[str]] = ..., tag_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class Note(_message.Message):
    __slots__ = ("id", "title", "content", "updated_at", "author_id", "permissions", "directory_ids", "tag_ids", "user_id", "attachment_ids", "shelf_ids")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    ...
    SHELF_IDS_FIELD_NUMBER: _ClassVar[int]
    id: str
    title: str
    content: str
    updated_at: _timestamp_pb2.Timestamp
    ...
    shelf_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., content: _Optional[str] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., author_id: _Optional[str] = ..., permissions: _Optional[_Iterable[_Union[PermissionRelationship, _Mapping]]] = ..., directory_ids: _Optional[_Iterable[str]] = ..., tag_ids: _Optional[_Iterable[str]] = ..., user_id: _Optional[str] = ..., attachment_ids: _Optional[_Iterable[str]] = ..., shelf_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class PostNoteRequest(_message.Message):
    __slots__ = ("title", "content", "author_id", "user_id", "shelf_id", "directory_ids")
    TITLE_FIELD_NUMBER: _ClassVar[int]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    AUTHOR_ID_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    shelf_id: str
    directory_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, title: _Optional[str] = ..., content: _Optional[str] = ..., author_id: _Optional[str] = ..., user_id: _Optional[str] = ..., shelf_id: _Optional[str] = ..., directory_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class AlterNoteRequest(_message.Message):
    __slots__ = ("id", "title", "content", "author_id", "directory_ids", "tag_ids", "user_id")
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    AUTHOR_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    content: str
    author_id: str
    directory_ids: IdsOrUndefined
    tag_ids: IdsOrUndefined
    user_id: str
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., content: _Optional[str] = ..., author_id: _Optional[str] = ..., directory_ids: _Optional[_Union[IdsOrUndefined, _Mapping]] = ..., tag_ids: _Optional[_Union[IdsOrUndefined, _Mapping]] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class Directory(_message.Message):
    __slots__ = ("id", "slug", "display_name", "description", "image_url", "parent_dir_ids", "relationships", "child_dir_ids", "child_note_ids", "shelf_ids")
    ID_FIELD_NUMBER: _ClassVar[int]
    SLUG_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    IMAGE_URL_FIELD_NUMBER: _ClassVar[int]
    PARENT_DIR_IDS_FIELD_NUMBER: _ClassVar[int]
    RELATIONSHIPS_FIELD_NUMBER: _ClassVar[int]
    CHILD_DIR_IDS_FIELD_NUMBER: _ClassVar[int]
    CHILD_NOTE_IDS_FIELD_NUMBER: _ClassVar[int]
    SHELF_IDS_FIELD_NUMBER: _ClassVar[int]
    id: str
    slug: str
    display_name: str
    description: str
    image_url: str
    parent_dir_ids: _containers.RepeatedScalarFieldContainer[str]
    relationships: _containers.RepeatedCompositeFieldContainer[PermissionRelationship]
    child_dir_ids: _containers.RepeatedScalarFieldContainer[str]
    child_note_ids: _containers.RepeatedScalarFieldContainer[str]
    shelf_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, id: _Optional[str] = ..., slug: _Optional[str] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., image_url: _Optional[str] = ..., parent_dir_ids: _Optional[_Iterable[str]] = ..., relationships: _Optional[_Iterable[_Union[PermissionRelationship, _Mapping]]] = ..., child_dir_ids: _Optional[_Iterable[str]] = ..., child_note_ids: _Optional[_Iterable[str]] = ..., shelf_ids: _Optional[_Iterable[str]] = ...) -> None: ...

class GetDirectoryRequest(_message.Message):
    __slots__ = ("id", "user_id", "include_parents", "include_child_dirs", "include_child_notes", "include_shelves")
    ID_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_PARENTS_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_CHILD_DIRS_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_CHILD_NOTES_FIELD_NUMBER: _ClassVar[int]
    INCLUDE_SHELVES_FIELD_NUMBER: _ClassVar[int]
    id: str
    user_id: str
    ...
    def __init__(self, id: _Optional[str] = ..., user_id: _Optional[str] = ..., include_parents: _Optional[bool] = ..., include_child_dirs: _Optional[bool] = ..., include_child_notes: _Optional[bool] = ..., include_shelves: _Optional[bool] = ...) -> None: ...

class GetDirectoriesRequest(_message.Message):
    __slots__ = ("user_id", "parent_id", "limit", "offset", "include_parents", "include_child_dirs", "include_child_notes", "include_shelves")
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    include_child_notes: bool
    include_shelves: bool
    def __init__(self, user_id: _Optional[str] = ..., parent_id: _Optional[str] = ..., limit: _Optional[int] = ..., offset: _Optional[int] = ..., include_parents: _Optional[bool] = ..., include_child_dirs: _Optional[bool] = ..., include_child_notes: _Optional[bool] = ..., include_shelves: _Optional[bool] = ...) -> None: ...

class CreateDirectoryRequest(_message.Message):
    __slots__ = ("name", "display_name", "description", "image_url", "parent_ids", "user_id")
    ...
    user_id: str
    def __init__(self, name: _Optional[str] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., image_url: _Optional[str] = ..., parent_ids: _Optional[_Iterable[str]] = ..., user_id: _Optional[str] = ...) -> None: ...

class AlterDirectoryRequest(_message.Message):
    __slots__ = ("id", "name", "display_name", "description", "image_url", "parent_ids", "user_id")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    parent_ids: _containers.RepeatedScalarFieldContainer[str]
    user_id: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., image_url: _Optional[str] = ..., parent_ids: _Optional[_Iterable[str]] = ..., user_id: _Optional[str] = ...) -> None: ...
